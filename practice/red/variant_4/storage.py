...
products_db: List[Product] = [
    Product(id=1, name="Ноутбук", description="Игровой ноутбук", price=89999.99, category="electronics", stock=5),
    Product(id=2, name="Футболка", description="Хлопковая футболка", price=1999.99, category="clothing", stock=20),
    Product(id=3, name="Яблоки", description="Свежие яблоки", price=149.99, category="food", stock=100),
]
...
def create_product(product_data: ProductCreate) -> Product:
    ...
    Returns:
        Созданный продукт с присвоенным id
        
    TODO: Реализовать функцию:
    1. Определить новый id (максимальный id в products_db + 1, или 1 если список пуст)
    2. Создать объект Product с новым id и данными из product_data
