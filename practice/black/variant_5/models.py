...
class EventCreate(BaseModel):
    ...
    - location - обязательное поле, строка от 1 до 200 символов
    - category - обязательное поле, строка: "conference", "workshop", "meeting" или "other"
    """
    pass
...
class Event(EventCreate):
    """
    Модель для чтения события (включает ID и дату создания)
    
    TODO: Наследовать от EventCreate и добавить поля:
...
class EventUpdate(BaseModel):
    ...
    - location - необязательное поле, строка от 1 до 200 символов или None
    - category - необязательное поле, строка: "conference", "workshop", "meeting" или "other", или None
    """
    pass
